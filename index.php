...
<section>
    <div class="container">
        <div class="col-12 ">
            <div class="heroImg position-relative">
                <img src="./assets/img/bannerimg.png" alt="heroimg" class="w-100 d-none d-md-block">
                <img src="./assets/img/mobilebg.png" alt="heroimg" class="w-100 d-block d-md-none">
                <div class="heroText position-absolute">
                    <h3>We Code,<br>
                        <span style="color:#FF843F;">Design</span> and<br>
                        Surf
                    </h3>
                </div>
            </div>
...
<main id="main">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="skillHeading">
                        <h2>Skills</h2>
                        <p class="mt-4">Le nostre competenze ci permettono<br>
                            di prendere il largo partendo dalla<br>
                            brand strategy al design, fino allo<br>
                            sviluppo full-stack di soluzioni web<br>
                            e mobile.</p>
                    </div>
                    <div class="messgaebtn"><a type="submit">Send Message</a></div>
                ...
                <div class="col-lg-6 pt-4 pt-lg-0">
                    <div class="accordion-container">
                        <div class="accordion-item" style="background-color: white;">
                            <button class="accordion-header" style="background-color: white;">
                                Brand Strategy <span class="icon">+</span>
                            </button>
            ...
            <div class="page1">
                ...
                <nav>
                    <div id="elm-container">
                        <div id="elm1" class="nav-part2"
                            data-image="https://img.freepik.com/free-psd/fresh-juice-cleanse-bottle-isolated-transparent-background_191095-25399.jpg?t=st=1715508536~exp=1715512136~hmac=f1afd01234ab5858c1f208b7a9029ac962e4911b1055c3625b35e23df26ae437&w=740">
                            <h4><a href="">DEVELOPMENT</a></h4>
                        </div>
                        <div id="elm1" class="nav-part2"
                            data-image="https://img.freepik.com/free-vector/aloe-vera-cosmetics-with-tubes-different-shape-colour-with-water-dispensers-text_1284-27019.jpg?t=st=1715511287~exp=1715514887~hmac=0e00bef3c30cf3e18343b26f09af1f0f36dcc09743f103ef6af8339616b1829b&w=740">
                            <h4><a href="">MARKETING</a></h4>
                        </div>
                        <div id="elm1" class="nav-part2"
                            data-image="https://img.freepik.com/premium-vector/cosmetics-blue-containers-lotion-shampoo-blurred-background_24908-18050.jpg?w=740">
    ...
    <section>
        <div class="container-fluid">
            <div class="section-title">
                <h2 class="clinentHeadong">Clients</h2>
            </div>
            <div class="col-12">
                <div class="page2">
                    <div class="moving">
                        <div class="con">
                            <h2>RedoTechnology</h2>
                            <div class="gola"></div>
                            <h2>MillionaireTrack</h2>
                            <div class="gola"></div>
                            <h2>BizMillion</h2>
                            <div class="gola"></div>
                        </div>
